...
- `v0.2.5` ✨✨✨ 维度 TAB 支持显示具体的文档、笔记本、工作空间名称
- `v0.2.4` `dock` 栏中的日历显示模式支持选择周视图或者日历视图
- `v0.2.4` 缩小 `dock` 栏中日历尺寸大小，以显示更多条任务
- `v0.2.4` ✨✨✨ `dock` 栏中的日历视图中 📍 标记 📍 每日待处理以及已完成的任务数量
- `v0.2.4` 文档、笔记本、工作空间 `TAB` 支持同时显示当前维度下的任务数量
